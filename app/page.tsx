...
export default function Home() {
  return (
    <main className="min-h-screen bg-[var(--background)] px-4 py-6 text-[var(--foreground)] sm:px-8 sm:py-10">
      <div className="mx-auto max-w-6xl overflow-hidden rounded-[38px] border border-[var(--border)] bg-[linear-gradient(180deg,color-mix(in_srgb,var(--surface)_97%,white),color-mix(in_srgb,var(--surface-muted)_82%,white))] shadow-[var(--shadow-strong)]">
        <section className="grid gap-6 px-6 py-8 sm:px-10 sm:py-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-4 max-w-3xl text-4xl font-semibold tracking-[-0.05em] text-[var(--foreground)] sm:text-5xl lg:text-[3.5rem]">
              Soruyu aç, çözüm modunu seç, direkt devam et.
            </h1>
            <p className="mt-4 max-w-2xl text-sm leading-7 text-[var(--foreground-muted)] sm:text-base">
              Bu alan tamamen bizim ekip için. Soruları ekleriz, çözeriz, gerekirse düzeltiriz. Kısacası boş boş dolanmak yok, direkt çalışmaya giriyoruz.
            </p>
